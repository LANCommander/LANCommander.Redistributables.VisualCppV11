...
$repository = 'LANCommander/LANCommander.Redistributables.VisualCppV11'
...
$stagingPath = Join-Path $temp "VisualCppV11-$version"
Remove-Item -LiteralPath $stagingPath -Recurse -Force -ErrorAction SilentlyContinue

$staging = New-Item -ItemType Directory -Force -Path $stagingPath
$package = Join-Path $temp "VisualCppV11-$version.lcx"
$payload = Join-Path $temp "VisualCppV11-$version-payload.zip"
